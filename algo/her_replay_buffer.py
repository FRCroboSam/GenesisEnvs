...
# https://github.com/alirezakazemipour/DDPG-HER/blob/master/memory.py
class Replay_Buffer_HER:
    def __init__(self, max_size, state_dim, action_dim, goal_dim, device):
        self.device = device
        self.max_size = max_size
        
        # Buffer stores: state, action, reward, next_state, achieved_goal, desired_goal, done
